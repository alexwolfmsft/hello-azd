...
module containerAppsEnvironment '../core/host/container-apps/managed.bicep' = {
...
module containerAppsApp '../core/host/container-apps/app.bicep' = {
  ...
  params: {
    ...
    secrets: [
      ...
      {
        name: 'storage-url' // Create a uniquely-named secret
        value: storageAccountEndpoint // NoSQL database account endpoint
      }
      {
    ...
    environmentVariables: [
      {
        name: 'azure-cosmos-db-nosql-endpoint' // Name of the environment variable referenced in the application
        secretRef: 'azure-cosmos-db-nosql-endpoint' // Reference to secret
      }
      {
        name: 'storage-url' // Name of the environment variable referenced in the application
        secretRef: 'storage-url' // Reference to secret
      }
      {
